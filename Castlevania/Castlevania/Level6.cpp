...
void Level6::LoadResources()
{
	...
	Scene_Index = 1;
	map = new Map();
	simon = new Simon(LV5_STAGE3.right * 2 - 200, LV5_STAGE3.bottom * 2 - 300, 3);
	...
	t->loadTextTureFromFile(L"Map/level6_tile.png", D3DCOLOR_XRGB(255, 0, 255));
	simon->LoadResource(L"Resources/simon.png", 8, 3, 0);
	Font::GetFont()->Innit();
	objManager->Init("Map/level6_object.txt");
	map->Init(L"Map/level6_tile.png", "Map/Level6_map.txt", 8, 12);
