...
Skeleton::Skeleton(int _id, int _type, int _x, int _y, int _Width, int _Height) :Enemy(_id, _type, _x, _y, _Width, _Height)
{
	startIndex = 0;
	index = 0;
	endIndex = 1;
...
void Skeleton::Update(Box RectCamera, Box simon, int Deltatime)
{
...
void Skeleton::CollisionWithObj(Object * obj)
{
	Box t = GetBox();
	t.h += vecY;
...
bool Skeleton::CheckCollision(Box simon)
{
